...
This is a lightweight data structure for representing angles. It is designed
to make performing common operations with angles easy, with a focus on
applications involving headings in the 2D plane.
